...
if __name__ == '__main__':
    ...
    def arrange_data(dataset, model):
        ...
        for i, ((images_s, id_s), (images_t, id_t)) in enumerate(dataset):
            if i < 120:
                ...
                features1, _ = model(images_s)
                features2, _ = model(images_t)
    ...
    model_state = os.path.join(args.save_dir, 'model_UDA_mnistm-svhn.pth.tar')
    #model_state = os.path.join(args.save_dir, 'model_UDA_svhn-mnistm.pth.tar')
